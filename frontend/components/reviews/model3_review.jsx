...
class Model3Review extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div className="car__reviewWhite">
        ...
        <div className={this.state.isMenuOpen ? "background-dim" : ""}>
          <div
            className="item"
            style={{ backgroundImage: `url(${window.model3URL})` }}
          >
            <div className="item__info">
              <div className="item__infoText">
                <h2>Model 3 Reviews</h2>
              </div>
...
const mapStateToProps = (state) => {
  ...
  const productId = productsArray[600].id;
...
export default connect(mapStateToProps, mapDispatchToProps)(Model3Review);

...
class ModelXReview extends React.Component {
  constructor(props) {
    super(props);
    ...
    return (
      <div className="car__reviewWhite">
        ...
        <div className={this.state.isMenuOpen ? "background-dim" : ""}>
          <div
            className="item"
            style={{ backgroundImage: `url(${window.modelXURL})` }}
          >
            <div className="item__info">
              <div className="item__infoText">
                <h2>Model X Reviews</h2>
              </div>
...
const mapStateToProps = (state) => {
  ...
  const productId = productsArray[300].id;
...
export default connect(mapStateToProps, mapDispatchToProps)(ModelXReview);
